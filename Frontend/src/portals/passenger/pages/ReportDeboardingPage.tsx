...
const ReportDeboardingPage: React.FC = () => {
    ...
    const [devOtp, setDevOtp] = useState<string>(''); // fallback OTP shown on screen
            ...
            if (data.success) {
                ...
                if (data.devOtp) {
                    ...
                    if (!data.emailSent) {
                        ...
                        toast.success(`OTP sent to ${masked}. Also shown on screen.`, { duration: 6000 });
                    }
                } else {
                    setDevOtp('');
            ...
            <div className="deboarding-container">
                ...
                {step === 3 && (
                    <div className="step-content">
                        ...
                        {/* Always show OTP on screen — email may reach spam or hit daily limits */}
                        {devOtp && (
                            <div style={{
                                background: '#fff3cd',
