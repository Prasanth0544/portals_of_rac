// tte-portal/src/pages/BoardingVerificationPage.jsx
...
function BoardingVerificationPage() {
    ...
    const fetchBoardingQueue = async () => {
        setLoading(true);
        setError('');

        try {
            const response = await axios.get(`${API_BASE}/tte/boarding-queue`, {
    ...
    const handleConfirmAll = async () => {
        ...
        try {
            const response = await axios.post(
                `${API_BASE}/tte/confirm-all-boarded`,
                {},
                { headers: { Authorization: `Bearer ${getToken()}` } }
            );
    ...
    const openConfirmDialog = (pnr, name) => {
        ...
        <Box sx={{ p: 3 }}>
            ...
            >
                ...
                <DialogActions>
                    ...
                    <Button
                        onClick={() => handleMarkNoShow(confirmDialog.pnr)}
                        color="error"
                        variant="contained"
                        autoFocus
                    >
