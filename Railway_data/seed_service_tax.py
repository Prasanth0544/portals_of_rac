"""
Seed service_tax collection into RailwayData MongoDB
Reads: mankatha_vari (service tax applicability rules)
"""
...
DB_NAME = "RailwayData"
COLLECTION = "service_tax"

DATA_FILE = r"C:\Users\prasa\Documents\RailWayData\base\assets\mankatha_vari"
...
def main():
    ...
    for d in docs[:3]:
        print(f"   {d['class_code']} | {d['train_type']} | tax={d['tax_applicable']}")
    client.close()
